...
public class GraphDemoFrame extends JFrame {
    ...
    private JButton buttonIsConnectivity;
    private JLabel labelIfConnectivity;
...
//                graph.searchCountGraphPaths(nStart, nFinish);
        ...
        buttonIsConnectivity.addActionListener(e -> {
            boolean isConnectivity = graph.isConnectivity();
            if (isConnectivity) {
                labelIfConnectivity.setText("Связан");
            } else {
                labelIfConnectivity.setText("Не связан");
            }
        });
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        buttonIsConnectivity = new JButton();
        buttonIsConnectivity.setBackground(new Color(-10158236));
        buttonIsConnectivity.setText("Проверка на связность");
        panel7.add(buttonIsConnectivity, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        labelIfConnectivity = new JLabel();
        labelIfConnectivity.setBackground(new Color(-6226016));
        labelIfConnectivity.setText("");
        panel8.add(labelIfConnectivity, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
